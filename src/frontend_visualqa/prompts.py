...
def build_verification_task(claim: str, url: str, navigation_hint: str | None = None) -> str:
    ...
    parts = [
        ...
        "- not_testable: the environment blocked verification",
        "",
        "Available tools include goto_url, left_click, double_click, triple_click, right_click, hover, drag, scroll, type, key_press, wait, refresh, go_back, go_forward, read_page, and find.",
