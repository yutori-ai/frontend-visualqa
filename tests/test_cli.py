...
def _sample_claim_result(*, url: str, viewport: ViewportConfig) -> ClaimResult:
    return ClaimResult(
        ...
        proof={
            "screenshot_path": "artifacts/run-fake/claim-01/step-00-initial.png",
            "step": 0,
            "after_action": None,
            "text": None,
            "text_path": None,
        ...
        trace={
            ...
            "screenshot_paths": ["artifacts/run-fake/claim-01/step-00-initial.png"],
            "actions": [],
            "trace_path": None,
        },
    )
...
def test_handle_verify_closes_runner_and_forwards_browser_config(monkeypatch: Any) -> None:
    ...
    assert claim_result["trace"]["screenshot_paths"] == ["artifacts/run-fake/claim-01/step-00-initial.png"]
